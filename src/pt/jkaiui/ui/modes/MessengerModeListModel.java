/*
 * MainModeListHandler.java
 *
 * Created on November 23, 2004, 7:13 PM
 */
...
public class MessengerModeListModel extends AbstractListModel {
    ...
    public Object getElementAt(int index) {
		try {
			...
			// trying to get the reason...
			//System.out.println("Error in getElementAt index:" + index + " msg:" + e.getMessage());
                    //System.out.println("MessageModeListModel:"+e);
			return null;
		}
    }
